...
*/
static const wchar_t filename_transform_chars[] =
{
...
static __forceinline uint32_t utf16_read_increment(const wchar_t **data, const wchar_t *last)
{
...
static __forceinline int utf16_write_increment(uint32_t codepoint, wchar_t **out, const wchar_t *outlast)
{
...
int utf8_to_utf16(const char *data, int srclen, wchar_t *outdata, int dstlen)
{
	const char *last = data + srclen;
	const wchar_t *outlast = outdata + dstlen;
	int outlen = 0;
	if (outdata)
	{
		while (data < last)
...
int utf8_to_utf16_filename(const char *data, int srclen, wchar_t *outdata, int dstlen)
{
	const char *last = data + srclen;
	const wchar_t *outlast = outdata + dstlen;
	int outlen = 0;
...
int utf16_to_utf8(const wchar_t *data, int srclen, char *outdata, int dstlen)
{
	const wchar_t *last = data + srclen;
...
int utf16_to_utf8_filename(const wchar_t *data, int srclen, char *outdata, int dstlen)
{
	const wchar_t *last = data + srclen;
	const char *outlast = outdata + dstlen;
	int outlen = 0;
